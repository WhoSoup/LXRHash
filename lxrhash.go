...
func (lx *LXRHash) PreHash(src []byte) ([]uint64, uint64, uint64, uint64, uint64, uint64, uint64, int) {
	...
	return hs, as, s1, s2, s3, delta, last, lastb
}

func (lx *LXRHash) PostHash(src []byte, i int, hs []uint64, as, s1, s2, s3, delta, last uint64, lastb int) []byte {
